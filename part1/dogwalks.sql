...
INSERT INTO WalkRequests (dog_id, requested_time, duration_minutes, location, status) VALUES
  ...
  ((SELECT dog_id FROM Dogs WHERE name='Rocky'), '2025-06-11 7:00:00', , 'Parklands', 'open'),
  ((SELECT dog_id FROM Dogs WHERE name='Milo'), '2025-06-12 10:30:00', 20, 'Beachside Ave', 'open'),
  ((SELECT dog_id FROM Dogs WHERE name='Luna'), '2025-06-12 12:00:00', 40, 'Botanic Garden', 'accepted');
